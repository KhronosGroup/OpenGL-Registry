...
* Modify extensions/registry.json to include the extension, using the next
...
* Once registry.json is updated, 'make' in extensions/ to update the PHP
...
* Once the pull request adding the extension specification and modifying
  registry.json is accepted, your extension is registered.
...
** extensions/registry.json - combined extension registry for all APIs
** extensions/makeindex.py - create HTML extension indices from registry.json
